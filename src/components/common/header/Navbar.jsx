        ...
        <ul className="flex items-center justify-between">
          ...
          <ul className="flex items-center gap-3 md:gap-6">
            <li className="cursor-pointer">
              ...
              >
                <span className="absolute -bottom-2 -left-1 w-5 h-5 rounded-full p-1 flex justify-center items-center text-xs bg-black text-white">
                  {cart?.length}
                </span>
                <svg
                  xmlns="http://www.w3.org/2000/svg"
              ...
              <Cart
                styles={`absolute top-[70px] min-h-[100vh] bg-white right-0 w-[100vw] md:w-[60vw] lg:w-[45vw]  xl:w-[40vw] 2xl:w-[500px] px-5 py-10 border-l`}
